...
// meta tag robots - handled automatically by enhanced SEO system
...
?>
  ...
  <div class="list-header">
    <div class="resp-wrapper">
      ...
      <?php 
      // Use enhanced H1 generation
      $enhanced_h1 = sigma_generate_h1();
      if(!empty($enhanced_h1)) { ?>
        <h1><?php echo osc_esc_html($enhanced_h1); ?></h1>
      <?php } elseif(trim(search_title()) <> '') { ?>
  ...
  <?php
    ...
    sigma_section_h2(__('Featured Listings','sigma'), array('class' => 'premium-section'));
  ...
  <?php if(osc_count_items() > 0) {
    // Use enhanced H2 for listings section
    $listings_title = (osc_count_premiums() > 0) ? __('All Listings','sigma') : __('Listings','sigma');
    sigma_section_h2($listings_title, array('class' => 'listings-section'));
