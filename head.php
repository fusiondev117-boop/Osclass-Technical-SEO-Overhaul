...
<?php 
// Use enhanced metadata if available, fallback to default
$enhanced_title = sigma_generate_optimized_title();
$enhanced_description = sigma_generate_optimized_description();
$page_title = !empty($enhanced_title) ? $enhanced_title : meta_title();
$page_description = !empty($enhanced_description) ? $enhanced_description : meta_description();
?>
<title><?php echo osc_esc_html($page_title); ?></title>
<meta name="title" content="<?php echo osc_esc_html($page_title); ?>" />
<?php if( $page_description != '' ) { ?>
<meta name="description" content="<?php echo osc_esc_html($page_description); ?>" />
<?php } ?>
<?php if( meta_keywords() != '' ) { ?>
<meta name="keywords" content="<?php echo osc_esc_html(meta_keywords()); ?>" />
<?php } ?>
<?php 
// Enhanced canonical tag implementation
$canonical_url = sigma_enhanced_canonical_tag();
if( $canonical_url != '' ) { ?>
<!-- canonical -->
<link rel="canonical" href="<?php echo osc_esc_html($canonical_url); ?>"/>
<!-- /canonical -->
<?php } ?>
...
// Performance optimized font and CSS loading handled by sigma_optimize_css_delivery()
